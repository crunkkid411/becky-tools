...
(function () {
  ...
  function renderVideoPicker() {
    ...
    state.videos.forEach((v) => {
      ...
      tr.title = busy ? "transcribing…" : (v.has_transcript ? "re-transcribe locally — writes a SEPARATE <name>_parakeet_transcription.srt; your original transcript is never touched" : "transcribe this video (local Parakeet ASR)");
