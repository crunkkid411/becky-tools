...
func main() {
	var (
		...
		minDur     = flag.Float64("min", 6, "minimum moment length (seconds)")
		maxDur     = flag.Float64("max", 360, "maximum moment length (seconds)")
		extend     = flag.Float64("extend", 20, "seconds past --max the ending may reach to complete a thought")
