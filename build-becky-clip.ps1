...
# the AI), click a quote to preview, double-click to add it to the timeline, burn a
...
try {
    ...
    Title "1/3  Building the window (search + preview + timeline + Underlord)..."
...
Say  "Tip: inside the window, Open a case folder, then search or ask the Underlord."
