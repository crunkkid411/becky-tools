...
if not exist ffinc (
  ...
  REM libavfilter (2x speed audio, step 2): atempo pitch-preserved time-stretch.
  xcopy /E /I /Q C:\msys64\mingw64\include\libavfilter ffinc\libavfilter >nul
)
call "C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\VC\Auxiliary\Build\vcvars64.bat" >nul
cl /nologo /O2 /MD /EHsc /std:c++17 /DIMGUI_ENABLE_FREETYPE /DIMGUI_USE_WCHAR32 /I"C:\msys64\mingw64\include\freetype2" /I"X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui" /I"X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui\backends" /I"X:\AI-2\becky-tools\native\timeline-bench\third_party\nlohmann" /Iffinc /I"C:\Program Files\gstreamer\1.0\msvc_x86_64\include\gstreamer-1.0" /I"C:\Program Files\gstreamer\1.0\msvc_x86_64\include\glib-2.0" /I"C:\Program Files\gstreamer\1.0\msvc_x86_64\lib\glib-2.0\include" main.cpp engine.cpp "X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui\imgui.cpp" "X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui\imgui_draw.cpp" "X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui\imgui_tables.cpp" "X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui\imgui_widgets.cpp" "X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui\backends\imgui_impl_win32.cpp" "X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui\backends\imgui_impl_dx11.cpp" "X:\AI-2\becky-tools\native\timeline-bench\third_party\imgui\misc\freetype\imgui_freetype.cpp" /Fe:becky-review.exe /link /MAP:becky-review.map /SUBSYSTEM:WINDOWS /ENTRY:mainCRTStartup /LIBPATH:"C:\Program Files\gstreamer\1.0\msvc_x86_64\lib" /LIBPATH:"C:\msys64\mingw64\lib" gstreamer-1.0.lib gstapp-1.0.lib gstvideo-1.0.lib gobject-2.0.lib glib-2.0.lib "C:/msys64/mingw64/lib/libavformat.dll.a" "C:/msys64/mingw64/lib/libavcodec.dll.a" "C:/msys64/mingw64/lib/libavutil.dll.a" "C:/msys64/mingw64/lib/libswresample.dll.a" "C:/msys64/mingw64/lib/libavfilter.dll.a" "C:/msys64/mingw64/lib/libfreetype.dll.a" d3d11.lib dxgi.lib d3dcompiler.lib gdi32.lib user32.lib shell32.lib comdlg32.lib windowscodecs.lib ole32.lib
